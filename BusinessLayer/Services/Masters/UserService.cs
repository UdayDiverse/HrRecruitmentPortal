...
namespace BusinessLayer.Services.Masters
{
    public class UserService(IUserRepository userRepository, IMapper mapper) : IUserService
    {
        public async Task<UserReadResponseModel?> GetByIdAsync(Guid id)
        {
            ...
            await EnrichUserNamesAsync(new List<UserReadResponseModel> { response });
            return response;
        }
        ...
        public async Task<UserSearchResponseModel?> SearchUserAsync(UserSearchRequestModel requestModel, string? offset, string count)
        {
            ...
            await EnrichUserNamesAsync(response.Users);
        ...
        private async Task EnrichUserNamesAsync(IEnumerable<UserReadResponseModel> users)
        {
            ...
            var names = await userRepository.GetUserNamesByIdsAsync(ids);
